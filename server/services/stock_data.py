...
STOCK_DEFINITIONS: List[Dict[str, str]] = [
    ...
    {"symbol": "MRVL", "country": "US", "currency": "USD", "name": "MRVL", "sector": "Global Equity"},
    {"symbol": "LHX", "country": "US", "currency": "USD", "name": "LHX", "sector": "Global Equity"},
    {"symbol": "AON", "country": "US", "currency": "USD", "name": "AON", "sector": "Global Equity"},
    {"symbol": "MMC", "country": "US", "currency": "USD", "name": "MMC", "sector": "Global Equity"},
    {"symbol": "PGR", "country": "US", "currency": "USD", "name": "PGR", "sector": "Global Equity"},
    {"symbol": "TRV", "country": "US", "currency": "USD", "name": "TRV", "sector": "Global Equity"},
    {"symbol": "MET", "country": "US", "currency": "USD", "name": "MET", "sector": "Global Equity"},
    {"symbol": "ALL", "country": "US", "currency": "USD", "name": "ALL", "sector": "Global Equity"},
    {"symbol": "AFL", "country": "US", "currency": "USD", "name": "AFL", "sector": "Global Equity"},
    {"symbol": "CB", "country": "US", "currency": "USD", "name": "CB", "sector": "Global Equity"},
    {"symbol": "ACGL", "country": "US", "currency": "USD", "name": "ACGL", "sector": "Global Equity"},
    {"symbol": "TROW", "country": "US", "currency": "USD", "name": "TROW", "sector": "Global Equity"},
    {"symbol": "BK", "country": "US", "currency": "USD", "name": "BK", "sector": "Global Equity"},
    {"symbol": "USB", "country": "US", "currency": "USD", "name": "USB", "sector": "Global Equity"},
    {"symbol": "PNC", "country": "US", "currency": "USD", "name": "PNC", "sector": "Global Equity"},
    {"symbol": "COF", "country": "US", "currency": "USD", "name": "COF", "sector": "Global Equity"},
    {"symbol": "DFS", "country": "US", "currency": "USD", "name": "DFS", "sector": "Global Equity"},
    {"symbol": "FITB", "country": "US", "currency": "USD", "name": "FITB", "sector": "Global Equity"},
    {"symbol": "KEY", "country": "US", "currency": "USD", "name": "KEY", "sector": "Global Equity"},
    {"symbol": "RF", "country": "US", "currency": "USD", "name": "RF", "sector": "Global Equity"},
    {"symbol": "CFG", "country": "US", "currency": "USD", "name": "CFG", "sector": "Global Equity"},
    {"symbol": "STT", "country": "US", "currency": "USD", "name": "STT", "sector": "Global Equity"},
    {"symbol": "TFC", "country": "US", "currency": "USD", "name": "TFC", "sector": "Global Equity"},
    {"symbol": "ZION", "country": "US", "currency": "USD", "name": "ZION", "sector": "Global Equity"},
    {"symbol": "LEN", "country": "US", "currency": "USD", "name": "LEN", "sector": "Global Equity"},
    {"symbol": "DHI", "country": "US", "currency": "USD", "name": "DHI", "sector": "Global Equity"},
    {"symbol": "PHM", "country": "US", "currency": "USD", "name": "PHM", "sector": "Global Equity"},
    {"symbol": "NVR", "country": "US", "currency": "USD", "name": "NVR", "sector": "Global Equity"},
    {"symbol": "EQR", "country": "US", "currency": "USD", "name": "EQR", "sector": "Global Equity"},
    {"symbol": "AVB", "country": "US", "currency": "USD", "name": "AVB", "sector": "Global Equity"},
    {"symbol": "SPG", "country": "US", "currency": "USD", "name": "SPG", "sector": "Global Equity"},
    {"symbol": "O", "country": "US", "currency": "USD", "name": "O", "sector": "Global Equity"},
    {"symbol": "DLR", "country": "US", "currency": "USD", "name": "DLR", "sector": "Global Equity"},
    {"symbol": "PSA", "country": "US", "currency": "USD", "name": "PSA", "sector": "Global Equity"},
    {"symbol": "CCI", "country": "US", "currency": "USD", "name": "CCI", "sector": "Global Equity"},
    {"symbol": "WELL", "country": "US", "currency": "USD", "name": "WELL", "sector": "Global Equity"},
    {"symbol": "VTR", "country": "US", "currency": "USD", "name": "VTR", "sector": "Global Equity"},
    {"symbol": "HCA", "country": "US", "currency": "USD", "name": "HCA", "sector": "Global Equity"},
    {"symbol": "ELV", "country": "US", "currency": "USD", "name": "ELV", "sector": "Global Equity"},
    {"symbol": "DXCM", "country": "US", "currency": "USD", "name": "DXCM", "sector": "Global Equity"},
    {"symbol": "ZBH", "country": "US", "currency": "USD", "name": "ZBH", "sector": "Global Equity"},
    {"symbol": "EW", "country": "US", "currency": "USD", "name": "EW", "sector": "Global Equity"},
    {"symbol": "BCBS", "country": "US", "currency": "USD", "name": "BCBS", "sector": "Global Equity"},
    {"symbol": "PODD", "country": "US", "currency": "USD", "name": "PODD", "sector": "Global Equity"},
    {"symbol": "ALGN", "country": "US", "currency": "USD", "name": "ALGN", "sector": "Global Equity"},
    {"symbol": "IDXX", "country": "US", "currency": "USD", "name": "IDXX", "sector": "Global Equity"},
    {"symbol": "IQV", "country": "US", "currency": "USD", "name": "IQV", "sector": "Global Equity"},
    {"symbol": "ILMN", "country": "US", "currency": "USD", "name": "ILMN", "sector": "Global Equity"},
    {"symbol": "BIIB", "country": "US", "currency": "USD", "name": "BIIB", "sector": "Global Equity"},
    {"symbol": "MCK", "country": "US", "currency": "USD", "name": "MCK", "sector": "Global Equity"},
    {"symbol": "CAH", "country": "US", "currency": "USD", "name": "CAH", "sector": "Global Equity"},
    {"symbol": "CIEN", "country": "US", "currency": "USD", "name": "CIEN", "sector": "Global Equity"},
    {"symbol": "APH", "country": "US", "currency": "USD", "name": "APH", "sector": "Global Equity"},
    {"symbol": "TEL", "country": "US", "currency": "USD", "name": "TEL", "sector": "Global Equity"},
    {"symbol": "NXPI", "country": "US", "currency": "USD", "name": "NXPI", "sector": "Global Equity"},
    {"symbol": "ON", "country": "US", "currency": "USD", "name": "ON", "sector": "Global Equity"},
    {"symbol": "MPWR", "country": "US", "currency": "USD", "name": "MPWR", "sector": "Global Equity"},
    {"symbol": "FIS", "country": "US", "currency": "USD", "name": "FIS", "sector": "Global Equity"},
    {"symbol": "FISV", "country": "US", "currency": "USD", "name": "FISV", "sector": "Global Equity"},
    {"symbol": "PAYX", "country": "US", "currency": "USD", "name": "PAYX", "sector": "Global Equity"},
    {"symbol": "ADP", "country": "US", "currency": "USD", "name": "ADP", "sector": "Global Equity"},
    {"symbol": "GPN", "country": "US", "currency": "USD", "name": "GPN", "sector": "Global Equity"},
    {"symbol": "VEEV", "country": "US", "currency": "USD", "name": "VEEV", "sector": "Global Equity"},
    {"symbol": "ANSS", "country": "US", "currency": "USD", "name": "ANSS", "sector": "Global Equity"},
    {"symbol": "CDNS", "country": "US", "currency": "USD", "name": "CDNS", "sector": "Global Equity"},
    {"symbol": "SNPS", "country": "US", "currency": "USD", "name": "SNPS", "sector": "Global Equity"},
    {"symbol": "FTNT", "country": "US", "currency": "USD", "name": "FTNT", "sector": "Global Equity"},
    {"symbol": "OKTA", "country": "US", "currency": "USD", "name": "OKTA", "sector": "Global Equity"},
    {"symbol": "MDB", "country": "US", "currency": "USD", "name": "MDB", "sector": "Global Equity"},
    {"symbol": "TTD", "country": "US", "currency": "USD", "name": "TTD", "sector": "Global Equity"},
    {"symbol": "ROKU", "country": "US", "currency": "USD", "name": "ROKU", "sector": "Global Equity"},
    {"symbol": "ROST", "country": "US", "currency": "USD", "name": "ROST", "sector": "Global Equity"},
    {"symbol": "TJX", "country": "US", "currency": "USD", "name": "TJX", "sector": "Global Equity"},
    {"symbol": "ORLY", "country": "US", "currency": "USD", "name": "ORLY", "sector": "Global Equity"},
    {"symbol": "AZO", "country": "US", "currency": "USD", "name": "AZO", "sector": "Global Equity"},
    {"symbol": "CVNA", "country": "US", "currency": "USD", "name": "CVNA", "sector": "Global Equity"},
    {"symbol": "MAR", "country": "US", "currency": "USD", "name": "MAR", "sector": "Global Equity"},
    {"symbol": "HLT", "country": "US", "currency": "USD", "name": "HLT", "sector": "Global Equity"},
    {"symbol": "LVS", "country": "US", "currency": "USD", "name": "LVS", "sector": "Global Equity"},
    {"symbol": "MGM", "country": "US", "currency": "USD", "name": "MGM", "sector": "Global Equity"},
    {"symbol": "WYNN", "country": "US", "currency": "USD", "name": "WYNN", "sector": "Global Equity"},
    {"symbol": "WY", "country": "US", "currency": "USD", "name": "WY", "sector": "Global Equity"},
    {"symbol": "DECK", "country": "US", "currency": "USD", "name": "DECK", "sector": "Global Equity"},
    {"symbol": "CROX", "country": "US", "currency": "USD", "name": "CROX", "sector": "Global Equity"},
    {"symbol": "RH", "country": "US", "currency": "USD", "name": "RH", "sector": "Global Equity"},
    {"symbol": "EL", "country": "US", "currency": "USD", "name": "EL", "sector": "Global Equity"},
    {"symbol": "OGDC.KA", "country": "Pakistan", "currency": "PKR", "name": "Oil & Gas Development Company", "sector": "Energy"},
    {"symbol": "PPL.KA", "country": "Pakistan", "currency": "PKR", "name": "Pakistan Petroleum", "sector": "Energy"},
    {"symbol": "MARI.KA", "country": "Pakistan", "currency": "PKR", "name": "Mari Petroleum", "sector": "Energy"},
    {"symbol": "PSO.KA", "country": "Pakistan", "currency": "PKR", "name": "Pakistan State Oil", "sector": "Energy"},
    {"symbol": "LUCK.KA", "country": "Pakistan", "currency": "PKR", "name": "Lucky Cement", "sector": "Materials"},
    {"symbol": "FFC.KA", "country": "Pakistan", "currency": "PKR", "name": "Fauji Fertilizer Company", "sector": "Materials"},
    {"symbol": "HBL.KA", "country": "Pakistan", "currency": "PKR", "name": "Habib Bank", "sector": "Finance"},
    {"symbol": "MEBL.KA", "country": "Pakistan", "currency": "PKR", "name": "Meezan Bank", "sector": "Finance"},
    {"symbol": "UBL.KA", "country": "Pakistan", "currency": "PKR", "name": "United Bank", "sector": "Finance"},
    {"symbol": "MCB.KA", "country": "Pakistan", "currency": "PKR", "name": "MCB Bank", "sector": "Finance"},
]
...
_LIVE_DATA_CACHE_TTL = 180  # 3 minutes cache validity
_IS_REFRESHING = False
_REFRESH_LOCK = threading.Lock()


def _build_baseline_snapshot() -> dict:
    """Instant baseline market snapshot so the dashboard renders in < 5ms even on cold boot."""
    fallback_map = {
        'AAPL': (278.28, 0.40), 'MSFT': (478.53, -0.54), 'GOOGL': (309.29, 0.25),
        'AMZN': (226.19, -0.51), 'TSLA': (458.96, 2.70), 'META': (644.23, -1.30),
        'NVDA': (175.02, -3.27), 'JPM': (318.52, 0.36), 'V': (347.83, 0.64),
    ...
    countries_covered = {s["country"] for s in STOCK_DEFINITIONS}
    ...
    for s in STOCK_DEFINITIONS:
        ...
        if fb:
            ...
            # Deterministic hash-based realistic baseline price per symbol
            hash_val = sum(ord(c) for c in sym)
            price = round(45.0 + (hash_val % 350) + 0.5, 2)
            chg_pct = round(((hash_val % 11) - 5) * 0.45, 2)

        direction = "up" if chg_pct >= 0 else "down"
        vol = 2500000 + (len(sym) * 120000)
    ...
    sentiment = round((positive_stocks / len(stocks_data) * 100), 1) if stocks_data else 55.0
    volatility = round((sum(abs(s["change_percent"]) for s in stocks_data) / len(stocks_data)), 2) if stocks_data else 1.2
    top_stock_picks = sorted(stocks_data, key=lambda s: (abs(s["change_percent"]), s["volume"]), reverse=True)[:6]

    return {
        "market_indicators": {
            "sentiment": sentiment, "volatility": volatility,
            "total_stocks": len(STOCK_DEFINITIONS), "total_volume": total_volume,
...
def _trigger_background_refresh():
    """Spawn background thread to refresh stock data if not already refreshing."""
    ...
    thread = threading.Thread(
        ...
        name="stocksense-market-refresh",
        daemon=True
    )
    thread.start()
...
def _run_background_refresh():
    ...
    try:
        ...
        if data is not None and not data.empty and _LIVE_DATA_CACHE is not None:
            ...
            sentiment = round((positive_stocks / len(successful) * 100), 1) if successful else 50.0
            volatility = round((sum(abs(s.get("change_percent", 0)) for s in successful) / len(successful)), 2) if successful else 1.2
            top_stock_picks = sorted(
                successful, key=lambda s: (abs(s.get("change_percent", 0)), s.get("volume", 0)), reverse=True
            )[:6]

            updated_data["stocks_data"] = all_stocks
            updated_data["top_stock_picks"] = top_stock_picks
            updated_data["market_indicators"]["sentiment"] = sentiment
            updated_data["market_indicators"]["volatility"] = volatility
            updated_data["market_indicators"]["last_updated"] = datetime.now().isoformat()
            updated_data["market_indicators"]["data_sources"]["yfinance_live"] = len(priority_symbols)

            _LIVE_DATA_CACHE = updated_data
            _LIVE_DATA_CACHE_TIME = time.time()

            try:
                from services.cache import cache
                cache.set("live_data", _LIVE_DATA_CACHE, ttl=300)
            except Exception:
                pass
...
def get_live_data() -> dict:
    """Fast global stock snapshot: guaranteed < 5ms response via Stale-While-Revalidate caching."""
    global _LIVE_DATA_CACHE, _LIVE_DATA_CACHE_TIME

    now = time.time()
    if _LIVE_DATA_CACHE is not None:
        if (now - _LIVE_DATA_CACHE_TIME) < _LIVE_DATA_CACHE_TTL:
            return _LIVE_DATA_CACHE
        # Stale: serve cached snapshot instantly and refresh in background
        _trigger_background_refresh()
        return _LIVE_DATA_CACHE

    # Cold start: build baseline snapshot immediately, trigger background refresh
    _LIVE_DATA_CACHE = _build_baseline_snapshot()
    _LIVE_DATA_CACHE_TIME = now
    _trigger_background_refresh()
    return _LIVE_DATA_CACHE
